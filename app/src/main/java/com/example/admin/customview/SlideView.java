...
public class SlideView extends View {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.SlideView, defStyleAttr, 0);
        try {
            mSliderColor = array.getColor(R.styleable.SlideView_Slidecolor, 0);
            mSliderBackground = array.getColor(R.styleable.SlideView_Backgroundcolor, 0);
